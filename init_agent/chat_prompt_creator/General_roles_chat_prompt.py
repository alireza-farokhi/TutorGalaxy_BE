General_roles = {
    ...
    "1" : """
            ...
            3- refer to the conversation especially the last messages avoid repeating yourself, you move on to the next action based on the instruction (this is very critical)
            4- each and every message of you should have the essense of who you are, so always erefr to that
            5- if you explain anything to user you do what ever you can to make things easy for the user to understand.
    """,
